...
static const char qt_meta_stringdata_TextDialog[] = {
    "TextDialog\0\0caption,text\0init(QString,QString)\0"
};
...
void TextDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->init((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData TextDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject TextDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_TextDialog,
      qt_meta_data_TextDialog, &staticMetaObjectExtraData }
};
